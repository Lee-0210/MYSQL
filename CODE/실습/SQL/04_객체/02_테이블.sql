...
/*
  CREATE TABLE 데이터베이스.테이블명 (
    컬럼1   데이터타입    [NULL/NOT NULL]   [DEFAULT]   [PRIMARY KEY | UNIQUE]    (COMMENT '컬렁설명'),
    컬럼2   데이터타입    [NULL/NOT NULL]   [DEFAULT]   [PRIMARY KEY | UNIQUE],
    컬럼3   데이터타입    [NULL/NOT NULL]   [DEFAULT]   [PRIMARY KEY | UNIQUE]
  ) COMMENT '테이블설명';
 */
...
-- 기존 테이블을 일부(name, value) 데이터만 복사하여 생성
